      ...
      <div className="navresponse">
        <nav className="nav2">
          ...
          <label for="check" className="checkbtn">
            <img
              alt="img"
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6k-WnmY7Fnzuk3u5d7jwEdOGf0GzUtfxypw&usqp=CAU"
              style={{ width: "80px" }}
            ></img>
          </label>
          <label class="logo">ایران چوب</label>
          <ul>
            <li>
              <Link
                style={{
        ...
        <br />
        <div style={{ padding: "2px", width: "300px" }}>{/* <Search /> */}</div>
      </div>
    </div>
  );
};
